...
| ---------------- | ----------------------------------------------------------------- | --------------------------------------------------- | ---------------------------------------------------------------- |
| Cleanup service  | Module (`src/features/queue-cleanup/services/cleanup.service.ts`) | Per-service stall detection + removal orchestration | `cleanupAll()`                                                   |
| Cleanup job      | Module (`src/features/queue-cleanup/jobs/cleanup.job.ts`)         | Cron entry point                                    | `runCleanupProcess()`                                            |
| Feature register | Module (`src/features/queue-cleanup/register.ts`)                 | Wires cron to SchedulerProvider                     | `registerQueueCleanup()`                                         |
...
| ---------------- | -------------------------------------------------------- | ------------------------------------------------- |
| Cleanup service  | `src/features/queue-cleanup/services/cleanup.service.ts` | `cleanupAll()`                                    |
| Cleanup job      | `src/features/queue-cleanup/jobs/cleanup.job.ts`         | `runCleanupProcess()`                             |
| Feature register | `src/features/queue-cleanup/register.ts`                 | `registerQueueCleanup()`                          |
