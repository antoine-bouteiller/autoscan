...
date: 2026-04-16
related: [docs/specs/architecture.spec.md, docs/specs/persistence.spec.md, src/providers/telegram/telegram.spec.md]
---
...
| --------------------- | ------------------------------------------------------------------------- | ---------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Language service      | Module (`src/features/language-sync/services/language.service.ts`)        | Preference storage + Plex stream reconciliation + Telegram UI builders | `handleUpdateLanguage`, `buildMediaTypeKeyboard`, `buildMediaKeyboard`, `buildLanguageKeyboard`, `selectMediaType`, `navigateMediaPage`, `selectMedia`, `selectLanguage` |
| Language job          | Module (`src/features/language-sync/jobs/language.job.ts`)                | Cron entry                                                             | `updatePlexSelectedLanguages`                                                                                                                                            |
| Telegram conversation | Module (`src/features/language-sync/commands/language.command.ts`)        | Multi-step `/setlanguage`                                              | `setLanguageConversation`                                                                                                                                                |
| Feature register      | Module (`src/features/language-sync/register.ts`)                         | Wires cron + telegram conversation                                     | `registerLanguageSync()`                                                                                                                                                 |
| Metadata service      | Shared (`src/media/metadata.service.ts`)                                  | TMDB lookup + media-row upsert (used by multiple features)             | `getMediaLanguage(tmdbId, mediaType)`, `getCompleteMediaDetails(ratingKey)`, `extractTmdbIdFromPath`, `buildMediaTitle`                                                  |
| Media repository      | Shared (`src/shared/media.repository.ts`)                                 | Drizzle queries                                                        | `getMediaByIdAndType`, `createdOrUpdatedMedia`, `getMediaByTypeWithPagination`, `countMediaByType`                                                                       |
...
| --------------------- | ---------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------- |
| Language service      | `src/features/language-sync/services/`   | `src/features/language-sync/services/language.service.ts`                                                                               |
| Language job          | `src/features/language-sync/jobs/`       | `src/features/language-sync/jobs/language.job.ts` (`updatePlexSelectedLanguages`)                                                       |
| Telegram conversation | `src/features/language-sync/commands/`   | `src/features/language-sync/commands/language.command.ts` (`setLanguageConversation`)                                                   |
| Feature register      | `src/features/language-sync/`            | `src/features/language-sync/register.ts` (`registerLanguageSync`)                                                                       |
| Feature types         | `src/features/language-sync/`            | `src/features/language-sync/types.ts` (`UpdateLanguageParams`)                                                                          |
| Metadata service      | `src/media/`                             | `src/media/metadata.service.ts` (`getMediaLanguage`, `getCompleteMediaDetails`, `extractTmdbIdFromPath`, `buildMediaTitle`)             |
| Media repository      | `src/shared/`                            | `src/shared/media.repository.ts` (`getMediaByIdAndType`, `createdOrUpdatedMedia`, `getMediaByTypeWithPagination`, `countMediaByType`)   |
