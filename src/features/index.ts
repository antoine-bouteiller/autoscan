...
import { subtitleScanFeature } from './subtitle_scan/feature.js'
import { transcodingFeature } from './transcoding/feature.js'

export const features = [languageSyncFeature, plexAuthFeature, queueCleanupFeature, sendMessageFeature, subtitleScanFeature, transcodingFeature]
